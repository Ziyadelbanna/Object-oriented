...
//	}
    ...
    private void validateCreateDB() throws ArrayIndexOutOfBoundsException , StringIndexOutOfBoundsException{
	...
	if(pos != arr.length-1)
	{
	    //error.reportError("CREATE DATABASE works only with one database");
	    return;
	}
	...
	CreateDB x = new CreateDB();
	x.setQuery("Create daTabase yyy mmm;");
